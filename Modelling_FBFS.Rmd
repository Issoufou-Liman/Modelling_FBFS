...
\begin{figure}[!htbp]
    \centering
    \includegraphics{figures/Modelling_FBFS_Avail_soil_water}
...
```{r figs,echo=FALSE,fig.width=14.2,fig.height=7.14,dpi=min_plots_res,fig.cap="\\label{fig:figs} Effect of the states of soil type manure application and flood water on the available soil water content at initial stage of crop development in Kisumu and Tigray"}
