...
```{r case-study-1-methods-details,eval=FALSE,include=FALSE,echo=FALSE,cache=FALSE}
source("source_files/case_study_1_methods_main.R")
```
...
```{r case-study-3-results-main,eval=FALSE,include=FALSE,echo=FALSE,cache=FALSE}
