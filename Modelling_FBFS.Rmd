...
ggsave(plot=g, device = 'png', filename = "figures/Modelling_FBFS_factor_of_soil_water.png", width = 14.2, 
       height =7.14, units = "in", dpi = min_plots_res
)
```
...
```{r fig8,echo=FALSE,fig.width=max_plots_width_in,fig.height=max_plots_height_in/1.5,dpi=min_plots_res,fig.cap="Expected biomass yield and other important yield-related metrics at initial stage of crop development in FBFS in Kisumu (Kenya) and Tigray (Ethiopia)."}

grid.draw(g)
ggsave(plot=g, device = 'png', filename = "figures/Modelling_FBFS_biomass_yield_initial_stage.png", width = 14.2, 
       height =7.14, units = "in", dpi = min_plots_res
)
```
...
```{r fig9,echo=FALSE,fig.width=max_plots_width_in,fig.height=max_plots_height_in/1.5,dpi=min_plots_res,fig.cap="Expected biomass yield and other important yield-related metrics at late stage of crop development in FBFS in Kisumu (Kenya) and Tigray (Ethiopia)."}

grid.draw(g)
ggsave(plot=g, device = 'png', filename = "figures/Modelling_FBFS_biomass_yield_late_stage.png", width = 14.2, 
       height =7.14, units = "in", dpi = min_plots_res
)
```
...
```{r fig11,echo=FALSE,fig.width=14.2,fig.height=7.14,dpi=min_plots_res,fig.cap="Joint effect of varying water supply and crop ennemies on grain yield of Sorghum and Rice in Kisumu (Kenya) and Tigray (Ethiopia)."}
...
g <- gTree(children = gList(ga, gb))
grid.draw(g)
ggsave(plot=g, device = 'png', filename = "figures/Modelling_FBFS_grain_yield.png", width = 14.2, 
       height =7.14, units = "in", dpi = min_plots_res
)
```
