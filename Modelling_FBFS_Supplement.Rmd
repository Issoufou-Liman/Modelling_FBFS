---
title: "Modelling Risk and Uncertainty in Flood-based Farming Systems – Supplementary Materials."
author:
...
```{r Cullen and Frey graph, include=FALSE, eval=FALSE}
...
```{r quantile and probability plots, include=FALSE, eval=FALSE}
